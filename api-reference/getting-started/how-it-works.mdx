...
1. Submit an application form here and wait to get approved.
...
4. Train a model using the [train model](/api/train-model) endpoint.
5. Fetch the images using the [get images](/api/get-model-generated-images) endpoint
6. Edit the images using any of our AI editing tools.

<Frame caption='We only save images uploaded for training, generated with models, or edited with AI tools. You can delete these anytime.'>
 <img src="/images/api-graph.png" />
</Frame>
...
Select the *model id* you'd like to train and pass it to the [train model](/api/train-model) endpoint.
